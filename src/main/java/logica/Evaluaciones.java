 ...
 * así como para
 * persistirlas en un archivo y actualizar la lista de evaluaciones desde el
 * archivo.
 * 
 */
public class Evaluaciones {
     ...
     * @return true si existe una evaluación con el título dado,
    ...
    /**
     * Obtiene una evaluación dado su número de índice en la lista de evaluaciones.
     * 
     * @param indice El índice de la evaluación en la lista.
     * @return La evaluación en el índice dado, o null si el índice
     *         está fuera de rango.
     */
